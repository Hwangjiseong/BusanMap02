...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let location = CLLocationCoordinate2D(latitude: 35.180100, longitude: 129.881017)
        ...
        let n = BusanData(coordinate: CLLocationCoordinate2D(latitude: 35.1527040, longitude:  129.1078090), title: "광안동", subTitle: "구 보건환경연구원 3층")
        let m = BusanData(coordinate: CLLocationCoordinate2D(latitude: 35.2047550, longitude:  129.1043270), title: "명장동", subTitle: "명장동 주민센터 옥상")
        ...
        MyMapView.addAnnotations([a,b,c,d,e,f,g,h,i,j,k,l,n,m,o,p,q,r,s,t,u])
